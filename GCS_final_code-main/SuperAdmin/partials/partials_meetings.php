...
<div class="col-lg-12 col-12 layout-top-spacing op-hidden" id="toremovebooks3">
                    ...
                    <div class="col-md-11 mx-auto">
                        <div class="row">
                            ...
                            <div class="col-12 text-right">
                                ...
                                <input type="hidden" name="datee" value="<?php echo htmlspecialchars($_GET['date']);?>">
                                <input type="hidden" name="SchoolCode" value="<?php echo htmlspecialchars($_GET['SchoolCode']);?>">
                                <input type="hidden" name="ReportType" value="VEC_Meeting">
