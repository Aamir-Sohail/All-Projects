            ...
            <div class="col-12">
                ...
                <div class="table-scrolled scrollbar">
                        <table id="multi-column-ordering" class="table table-hover dataTable no-footer" role="grid"
                            ...
                            $data = $datafetch->fetchComplaints($_SESSION['District']);
                            $no = 1;
                            ...
                            foreach ($data as $row) {
                                ...
                                <img src="../uploads/<?php //echo $row['attachment'] ?>" alt="" srcset="">    
                                 -->
                                    ...
                                    <td class="sorting_1 sorting_2" style="width:200px">
                                        <div class="btn-group">
                                            <button onclick="viewComplaints(<?php echo $row['AutoId'];?>)" type="button"
                                                class=" btn btn-primary mr-1" data-toggle="modal"
                                                data-target="#myViewModal">View</button>
                                            <button onclick="deleteComplaints(<?php echo $row['AutoId'];?>)"
    ...
    function viewComplaints(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#msg").html("<h6>Message:</h6> <br>" + result.msg +
                    "<br><br><br><h6>Attachment:</h6><img src='../uploads/'" + result.attachment + ">");
            }
        });
    }
</script>