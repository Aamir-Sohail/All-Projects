                        ...
                        <table id="multi-column-ordering" class="table table-hover dataTable no-footer" role="grid"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="multi-column-ordering" rowspan="1"
                                        colspan="1" style="width: 142.562px;">Total Boys</th>
                                    <th class="sorting" tabindex="0" aria-controls="multi-column-ordering" rowspan="1"
                                        colspan="1" style="width: 142.562px;">Total Girls</th>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    ?>
                                    <td class="sorting_1 sorting_2"><?php echo $student['Nursery_Boys']+$student['KG_Boys']+$student['One_Boys']+$student['Two_Boys']+$student['Three_Boys']+$student['Four_Boys']+$student['Five_Boys'];?></td>
                                    <td class="sorting_1 sorting_2"><?php echo $student['Nursery_Girls']+$student['KG_Girls']+$student['One_Girls']+$student['Two_Girls']+$student['Three_Girls']+$student['Four_Girls']+$student['Five_Girls'] ?></td>
